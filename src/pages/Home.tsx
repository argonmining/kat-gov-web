      ...
      <div className="container mx-auto mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="/proposals" className="p-4 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 shadow rounded-lg text-center">
              <h3 className="font-bold">View Proposals</h3>
            </a>
            <a href="/submit-proposal" className="p-4 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 shadow rounded-lg text-center">
              <h3 className="font-bold">Submit Proposal</h3>
            </a>
            <a href="/elections" className="p-4 bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 shadow rounded-lg text-center">
